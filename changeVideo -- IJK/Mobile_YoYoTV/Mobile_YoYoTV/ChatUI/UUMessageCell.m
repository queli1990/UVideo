...
//        _headImageBackView.backgroundColor = [[UIColor grayColor] colorWithAlphaComponent:0.4];
        ...
        self.headImageButton.layer.cornerRadius = 5;
...
//                                 placeholderImage:[UIImage uu_imageWithName:@"headImage.jpeg"]];
    if (messageFrame.message.from == UUMessageFromMe) {
        [self.headImageButton setBackgroundImage:[UIImage imageNamed:@"userHeader"] forState:UIControlStateNormal];
    } else {
        [self.headImageButton setBackgroundImage:[UIImage imageNamed:@"sysHeader"] forState:UIControlStateNormal];
    }
    ...
    UIImage *normal;
    if (message.from == UUMessageFromMe) {
        normal = [UIImage uu_imageWithName:@"chatfrom_bg_normal_Rectangle"];
        normal = [normal resizableImageWithCapInsets:UIEdgeInsetsMake(35, 10, 10, 22)];
    }
    else{
        normal = [UIImage uu_imageWithName:@"chatto_bg_normal_Rectangle"];
